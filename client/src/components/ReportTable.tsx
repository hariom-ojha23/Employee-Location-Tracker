          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell className="table-cell-inner">Date</TableCell>
                    <TableCell className="table-cell-inner">Customer</TableCell>
                    <TableCell className="table-cell-inner" align="right">
                      Amount
                    </TableCell>
                    <TableCell className="table-cell-inner" align="right">
                      Total price ($)
                ...
                <TableBody>
                  {row.history.map((historyRow) => (
                    <TableRow key={historyRow.date}>
                      ...
                      <TableCell className="table-cell-inner">
